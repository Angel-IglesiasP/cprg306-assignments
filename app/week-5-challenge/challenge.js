    ...
    <div className="p-8 space-y-12">
      ...
      <section className="border p-6 rounded-lg">
        ...
        <div className="space-x-2">
          <button onClick={() => setCounter(counter + 1)} disabled={isDisabled} className="px-4 py-2 bg-blue-500 text-white rounded disabled:bg-gray-300 disabled:cursor-not-allowed">
            Increase
          </button>
          <button onClick={() => setCounter(counter - 1)} disabled={isDisabled} className="px-4 py-2 bg-red-500 text-white rounded disabled:bg-gray-300 disabled:cursor-not-allowed">
            Decrease
          </button>
        </div>
      </section>
